...
//                log.info("Call receiver", "skipping intent=" + intent + ", extras=" + intent.getExtras() + " - no number was supplied");
                return;
            }
            String number = intent.getStringExtra(TelephonyManager.EXTRA_INCOMING_NUMBER);

//            Toast.makeText(context,"asdfasdf",Toast.LENGTH_SHORT).show();
            if(number==null || number.equals("null")) intent.getExtras().getString(TelephonyManager.EXTRA_INCOMING_NUMBER);
